...
usage() {
cat << EOF
Usage: $0 -i <input_dir> -o <output_dir> [--aligner <aligner>] [options]
...
Optional:
  --aligner <aligner>         Aligner to use: star, hisat2, both, or omit to prompt at runtime
...
Examples:
  ...
  # Use STAR with default reference (non-interactive)
